...
// // playerCards will be the cards the player has in their hand
// Deck playerCards = new Deck();
// // playerMoney holds players cash - we will be lazy and use doubles instead
// of
// // bigdecimals
// double playerMoney = 100.0;
// // dealerCards will be the cards the dealer has in their hand
...
// if (response == 1) {
// playerCards.draw(playingDeck);
// System.out.println("You draw a:" + playerCards.getCard(playerCards.deckSize()
// - 1).toString());
// // Bust if they go over 21
// if (playerCards.cardsValue() > 21) {
// System.out.println("Bust. Currently valued at: " + playerCards.cardsValue());
...
// false) {
// System.out.println("Dealer beats you " + dealerCards.cardsValue() + " to " +
// playerCards.cardsValue());
// playerMoney -= playerBet;
// endRound = true;
// }
